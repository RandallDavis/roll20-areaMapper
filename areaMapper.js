...
var APIAreaMapper = APIAreaMapper || (function() {
    ...
    */
    ...
    area.prototype.useUniqueAsset = function(objectType, assetState) {
        var textureObject = new texture();
        textureObject.setProperty('textureType', 'unique');
        textureObject.setProperty('value', assetState);
    ...
    interfaceManageAssets = function(who) {
        ...
        - cycle (for edits)
        area:
        - cycle (for edits / changing area settings)
    ...
    interfaceGlobalAssetEdit = function(who) {
        ...
        if(!state.APIAreaMapper.globalAssetEdit) {
            log('interfaceGlobalAssetEdit() called without state.APIAreaMapper.globalAssetEdit.');
            return;
        }
